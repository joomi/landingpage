    ...
    <!--[if lt IE 9]>
      <script src="<?php echo base_url();?>lp_app/views/templates/basic/bs_carousel/js/html5shiv.js"></script>
    <![endif]-->

    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url();?>lp_app/views/templates/basic/bs_carousel/ico/apple-touch-icon-144-precomposed.png">
