<div class="lp_container" role="heading">
    <a href="http://sdf"><img src="http://placehold.it/120x60" style="border-width:2px; border-style:dashed; border-color:#666" class="lp_img def_logo" data-role="lp_element" id="lp_logo" data-width="120" data-height="60" title="company name" alt="company name" /></a>
    <h1 data-role="text">Campaign title</h1>
    <div class="def_topMenu" data-name="The top menu area">
        <a href="#" data-role="link">LINK</a> | <a href="#" data-role="link">LINK</a> | <a href="#" data-role="link">LINK</a> | <a href="#" data-role="link">LINK</a>
    </div>
    <div class="clear"></div>
</div>
<div class="lp_container" role="heading">
    <img id="lp_headerimg" src="http://placehold.it/960x90" class="lp_img def_headerImg" data-role="lp_element" data-width="100%" data-height="90" title="company name" alt="company name" />
</div>
<div role="main" data-role="sortable" class="lp_container def_main lp_main">
    <div data-role="lp_element" class="def_leftCol def_contentCol" data-name="Text block element">
        ...
        <div id="lp_video_wrapper"><iframe width="259" height="146" src="http://www.youtube.com/embed/v0PDemkEPMs" frameborder="0" allowfullscreen></iframe></div>
    </div>
    <div data-role="lp_element" class="def_midCol def_contentCol" data-name="Text block element">
        <h3 data-role="text">Title Header</h3>
        <p data-role="text">Normally, both your asses would be dead as fucking fried chicken, but you happen to pull this shit while I'm in a transitional period so I don't wanna kill you, I wanna help you. But I can't give you this case, it don't belong to me. Besides, I've already been through too much shit this morning over this case to hand it over to your dumb ass.</p>
        <img src="http://placehold.it/120x120" id="lp_content_img_1" class="lp_img def_contentImg" data-role="lp_element" data-width="120" data-height="120" title="" alt="" />                
    </div>
    <div data-role="lp_element" class="def_rightCol def_formHolder def_contentCol" data-name="Text block element">
        ...
        <form name="contact-form" data-role="form" id="lp_contact-form" class="lp_validate def_form" contenteditable="false">
            ...
            <div class="lp_form_row">
                ...
                <input type="email" name="lpForm[Email]" class="def_inputbox" id="Email">
            </div>
            <div class="lp_form_row">                    
